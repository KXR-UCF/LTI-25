...
import { type PressureDataPoint } from "../interfaces";
...
function PressureTransducerGraph({
    pressureData,
    completePressureData,
    exportCompleteChart
    ...
    const exportPressureChart = () => {
        ...
        exportCompleteChart(
            completePressureData,
            `pressure-complete-session-${timestamp}`,
            false
        );
    };
...
export default PressureTransducerGraph
